  ...
  return (
    <header className="h-16 border-b border-border/50 bg-background/80 backdrop-blur-xl flex items-center justify-between px-6 sticky top-0 z-50">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="w-9 h-9 rounded-full bg-gradient-to-br from-primary/50 to-node-secondary/50 flex items-center justify-center ml-2 cursor-pointer hover:ring-2 hover:ring-primary/30 transition-all">
